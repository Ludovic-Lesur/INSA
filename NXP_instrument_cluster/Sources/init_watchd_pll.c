...
void MC_MODE_INIT_PLL()
{
	...
	CGM.SC_DC[0].R = (unsigned char) 0x80808080 ;
	CGM.SC_DC[1].R = (unsigned char) 0x80808080 ;
	CGM.SC_DC[2].R = (unsigned char) 0x80808080 ;
	CGM.SC_DC[3].R = (unsigned char) 0x80808080 ;
