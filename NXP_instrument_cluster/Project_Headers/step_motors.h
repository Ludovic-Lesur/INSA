...
struct StepMotor {
	...
	int ready ;
	// Positioning
	unsigned int offset ; // Number of steps required to indicate 'valueMin'.
	...
	int logic ; // 0 => stepUp() to increase value.
				...
				// Depends on the mechanical configuration of the step motor and its needle.
} ;
