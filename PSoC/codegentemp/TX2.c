...
*
* \funcusage
*  \snippet TX2_SUT.c usage_TX2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TX2_SUT.c usage_TX2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TX2_SUT.c usage_TX2_Read  
*******************************************************************************/
uint8 TX2_Read(void)
{
...
* preferred TX2_Read() API because the 
* TX2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TX2_SUT.c usage_TX2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TX2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TX2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TX2_0_INTR       (First pin in the list)
    *  - TX2_1_INTR       (Second pin in the list)
    *  - ...
    *  - TX2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TX2_SUT.c usage_TX2_SetInterruptMode
    *******************************************************************************/
    void TX2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TX2_0_INTR) != 0u) 
		{ 
			 TX2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TX2_SUT.c usage_TX2_ClearInterrupt
    *******************************************************************************/
